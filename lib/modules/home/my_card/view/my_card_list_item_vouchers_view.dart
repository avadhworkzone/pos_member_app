...
class MyCardItemVouchersView extends StatefulWidget {
  final int index;

  const MyCardItemVouchersView({super.key, required this.index});

  @override
  State<MyCardItemVouchersView> createState() => _MyCardItemVouchersViewState();
}

class _MyCardItemVouchersViewState extends State<MyCardItemVouchersView> {
  ...
  Widget build(BuildContext context) {
    return _buildMyCardItemVouchersViewView();
  }

  static int countVouchers = 1;

  _buildMyCardItemVouchersViewView() {
    countVouchers++;
    return Container(
